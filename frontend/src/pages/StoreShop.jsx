  ...
  return (
    <>
      <div className="storeshop-banner-wrapper">
        <img
          src={`http://localhost:5000/uploads/${shop.banner_image}`}
          alt="Banner"
      ...
      <div className="storeshop-page">
        <div className="storeshop-header">
          <img
            src={`http://localhost:5000/uploads/${shop.logo_image}`}
            alt="Logo"
        ...
        <h2 style={{ margin: "2rem 0 1rem", fontSize: "1.5rem", color: "var(--primary-color)" }}>
          All Products
        </h2>
